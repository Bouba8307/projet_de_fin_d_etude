...
@section('content')
<!-- BEGIN: En-tête -->
<header class="page-header page-header-dark bg-black pb-10">
        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item active">Commandes terminées</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xl px-4 mt-n4">
        ...
        <div class="alert alert-success alert-icon" role="alert">
            ...
            <div class="alert-icon-content text-black">
                {{ session('success') }}
            </div>
        </div>
        @endif
                    ...
                    <form action="#" method="GET">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="form-group row align-items-center justify-content-between">
                                <label class="control-label col-sm-4" for="search">Recherche:</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="submit" class="input-group-text bg-black"><i class="fa-solid fa-magnifying-glass font-size-20 text-white"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
