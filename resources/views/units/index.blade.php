        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('units.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus me-3"></i>Ajouter</a>
                    <a href="{{ route('units.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Effacer la recherche</a>
                </div>
            </div>
                    ...
                    <form action="{{ route('units.index') }}" method="GET">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="form-group row align-items-center">
                                <label for="row" class="col-auto">Lignes :</label>
                                <div class="col-auto">
                            ...
                            <div class="form-group row align-items-center justify-content-between">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="search" class="form-control me-1" name="search" placeholder="Rechercher une unité" value="{{ request('search') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col">N°</th>
                                    <th scope="col">@sortablelink('name', 'Nom de l\'unité')</th>
                                    <th scope="col">@sortablelink('slug', 'Slug de l\'unité')</th>
