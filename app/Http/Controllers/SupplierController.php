...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('suppliers.index')->with('success', 'Un nouveau fournisseur a été créé !');
    }
    ...
    public function update(Request $request, Supplier $supplier)
    {
        ...
        return Redirect::route('suppliers.index')->with('success', 'Le fournisseur a été mis à jour!');
    }
    ...
    public function destroy(Supplier $supplier)
    {
        ...
        return Redirect::route('suppliers.index')->with('success', 'Le fournisseur a été supprimé!');
    }
}
